...
namespace Math
{
	...
	static MM_INLINE mtx4x4 MM_VECTORCALL MatrixTranslation(f32 x, f32 y, f32 z)
	{
		mtx4x4 out_mtx;
	...
	static MM_INLINE mtx4x4 MM_VECTORCALL MatrixRotationY(f32 angle_rad)
	{
		mtx4x4 out_mtx;
	...
	static MM_INLINE mtx4x4 MM_VECTORCALL MatrixScale(f32 x, f32 y, f32 z)
	{
		mtx4x4 out_mtx;
	...
	static MM_INLINE mtx4x4 MM_VECTORCALL MatrixMul(mtx4x4 const& a, mtx4x4 const& b)
	{
	...
	static MM_INLINE mtx4x4 MM_VECTORCALL MatrixTranspose(mtx4x4 const& mtx)
	{
	...
	static MM_INLINE mtx4x4 MM_VECTORCALL MatrixLookAtLH(vec3 eye_pos, vec3 look_at, vec3 up_dir)
	{
	...
	static MM_INLINE mtx4x4 MM_VECTORCALL MatrixPerspectiveFovLH(f32 fov_y_rad, f32 aspect_ratio, f32 near_z, f32 far_z)
	{
	...
	static MM_INLINE vec3 MM_VECTORCALL Vec3Zero()
	{
	...
	static MM_INLINE vec4 MM_VECTORCALL Vec4Zero()
	{
	...
	static MM_INLINE vec4 MM_VECTORCALL Vec4DefaultPos()
	{
	...
	// Returns a vec4 (0,0,0,0).
	static MM_INLINE vec4 MM_VECTORCALL Vec4DefaultDir()
	{
		return Vec4Zero();
	}

	static MM_INLINE vec3 MM_VECTORCALL UpDir()
	{
	...
	static MM_INLINE f32 MM_VECTORCALL RadToDegree(f32 rad)
	{
		return rad * (180.0f / Pi);
	}

	static MM_INLINE f32 MM_VECTORCALL DegreeToRad(f32 degree)
	{
